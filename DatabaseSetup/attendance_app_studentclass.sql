...
CREATE TABLE `studentclass` (
  ...
  PRIMARY KEY (`userId`,`classNo`),
  KEY `classNo` (`classNo`),
  CONSTRAINT `studentclass_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE,
...
-- Dump completed on 2026-04-16 12:54:58
